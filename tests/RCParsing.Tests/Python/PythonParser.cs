...
{
	/// <summary>
	/// The Python 3.13 parser. Grammar took from https://github.com/antlr/grammars-v4/tree/master/python/python3_13
	/// </summary>
	public static class PythonParser
	{
		public static void FillWithRules(ParserBuilder builder)
		{
			...
			builder.CreateRule("bitwise_xor")
				.Rule("bitwise_and")
				.Rule("bitwise_xor_tail");

			builder.CreateRule("bitwise_xor_tail")
				.Choice(
					b => b
						.Literal("^")
						.Rule("bitwise_and")
			...
			builder.CreateRule("bitwise_and")
				.Rule("shift_expr")
				.Rule("bitwise_and_tail");

			builder.CreateRule("bitwise_and_tail")
				.Choice(
					b => b
						.Literal("&")
						.Rule("shift_expr")
			...
			builder.CreateRule("shift_expr_tail")
				.Choice(
					b => b
						.LiteralChoice("<<", ">>")
						.Rule("sum")
			...
			builder.CreateRule("t_primary_tail")
				.Choice(
					b => b
						.Choice(
							b => b
			...
			builder.Settings.Skip(b => b.Token("SKIP").ConfigureForSkip(),
