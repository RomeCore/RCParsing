...
{
	/// <summary>
	/// Represents an error recovery strategy that skips input after an anchor rule is found, with an optional stop rule.
	/// </summary>
	public class SkipAfterAnchorWithStopErrorRecoveryStrategy : ErrorRecoveryStrategy, IInitializeAfterBuild
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SkipAfterAnchorWithStopErrorRecoveryStrategy"/> class.
		/// </summary>
		...
		public SkipAfterAnchorWithStopErrorRecoveryStrategy(int anchorRuleId, int stopRuleId, bool repeatSkip = false)
		{
