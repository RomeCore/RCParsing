...
namespace RCParsing.Building.TokenPatterns
{
	...
	/// </summary>
	public class BuildableSecondTokenPattern : BuildableTokenPattern
	{
		/// <summary>
		...
		{
			return new SecondTokenPattern(tokenChildren[0], tokenChildren[1]);
		}

		public override bool Equals(object? obj)
		{
			return base.Equals(obj) &&
				   obj is BuildableSecondTokenPattern other &&
				   First == other.First &&
				   Second == other.Second;
		}
